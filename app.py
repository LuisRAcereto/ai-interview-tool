...
if not st.session_state.setup_complete:
    ...
    if "positioin" not in st.session_state:
...
if st.session_state.setup_complete and not st.session_state.feedback_shown and not st.session_state.chat_complete:
    ...
    print(f"""
    You are an HR executive for the company {st.session_state["company"]} and are interviewing a user named {st.session_state["name"]} for the position {st.session_state["position"]} and level {st.session_state["level"]}
    ...
    Ask each question individually, creating a conversation flow rather than presenting all the questions simultaneously.
    """)
        ...
        messages=[
            {
                ...
                "content": """
                    ...
                    Feedback: //Here you put you feedback
                    Give only the feedback do not ask any aditional questions.
                    """
            },{
                "role": "user",
                "content": f"This is an interview you need to evaluate. Keep in mind that you are only a tool. And you shouldn't engage in conversation {conversation_history}"
            }
        ]
    )
